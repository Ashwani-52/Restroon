...
// Plan IDs MUST match backend SUBSCRIPTION_PLANS keys exactly:
// trial | monthly | quarterly | biannual | annual
const PLANS = [
  {
    id:         "trial",
    emoji:      "🌱",
    ...
    priceLabel: "FREE",
    duration:   "24 Hours",
    note:       "₹1 card auth — refunded instantly",
    features: [
